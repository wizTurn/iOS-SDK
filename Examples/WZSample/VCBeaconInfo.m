...
@interface VCBeaconInfo () <WZBeaconManagerDelegate>
{
...
- (id)initWithNibName:(NSString *)nibNameOrNil bundle:(NSBundle *)nibBundleOrNil
{
    ...
    if (self) {
        ...
        _pebbleImageView = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"icon-iOS"]];
...
- (void)setBeacon:(WZBeacon *)beacon
{
    _beacon = beacon;
    [self displayBeacon];
}
...
- (void)displayBeacon
{
    ...
    _RSSICell.valueLabel.text = [NSString stringWithFormat:@"%ld db", (long)self.beacon.rssi];
...
{
    for (WZBeacon *beacon in beacons)
    {
        if ([[self.beacon.proximityUUID UUIDString] isEqualToString:
